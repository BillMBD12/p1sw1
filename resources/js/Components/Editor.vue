        ...
        <ul class="grid w-full gap-2 md:grid-rows-2">
          <li>
            ...
            <label for="arrow_triangle"
              class="inline-flex items-center justify-center w-full py-2 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-red-600 peer-checked:text-red-600 hover:text-gray-600 hover:bg-gray-100 ">
